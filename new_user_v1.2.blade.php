...
<body>
    <div class="correo-container" style="box-shadow: 10px 10px 18px 0px rgba(0,0,0,0.18)">
        ...
        <div class="p-5">
            <img src="http://www.claronetworks.openofficedospuntocero.info/API_images/group-3.png" class="form-image-blue" alt="vector-azul"/>
            ...
            <p class="a-text-black-regular">Por favor, confirma tu cuenta de Claro Networks dando click en el siguiente
                botón:</p>
            <div class="m-btn">
                <a href="http://www.claronetworks.openofficedospuntocero.info/v1.2/home.php?{{$info['token']}}"><button class="form-button-primary a-text-white-bold">¡COMENZAR!</button></a>
            </div>
