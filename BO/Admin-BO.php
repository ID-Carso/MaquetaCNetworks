...
<body class="scroll">
    ...
    <main>
       ...
       showHeader($nameButton, 1);
        ?>
         <nav class='navbar navbar-expand-sm   mx-auto mt-xl-0'style ="display:flex; justify-content:space-around">
            <ul class='navbar-nav'>
              <li class='nav-item'>
                <button  class=' buttonall btn-nav  btn-select ml-xl-4 pr-4 pl-4 textbottom 'type='button' id="btn-nav"   rel='Admin-home-BO' onClick="muestra1()">Administrar sitio</button>       
              </li>
              <li class='nav-item'>
