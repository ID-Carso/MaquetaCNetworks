    ...
    success: function success(result) {
      ...
      programingCanalClaro.forEach(function (program, index) {
        ...
        if (arrayCanalClaro.includes(program.chapter_id)) {
          ...
          programCanalClaroEdit += "\n          <div class=\"p-3 border-t border-r border-l border-b position-relative mb-3\">\n          <img src=\"./images/General/pencil.svg\" alt=\"\" class=\"pencil edit-program-pencil\" chapter_id=\"".concat(program.chapter_id, "\">\n        <div class=\"schedule-container col-12 p-5 mx-auto mt-0\">\n        <p class=\"schedule-title  a-text-plus a-text-black-brown-two\"> \n      \n  ").concat(program.chapter_title, "\n     \n  </p>\n<div class=\"schedule-item-body\">\n  <div class=\"schedule-poster\">\n     <div class=\"poster\">\n          <div class=\"thumbnail-edit\" _id=\"").concat(program.chapter_id, "\">\n          <img src=\"").concat(program.image, "\" alt=\"\" class=\"w-100\">\n          </div>\n      </div>\n  </div>\n  <div class=\"schedule-details\">\n      <div class=\"schedule-details-header\">\n          <div>\n              <p class=\"schedule a-text-black-brown-two\">\n                  \n              ").concat(program.time, " hrs.\n                  \n              </p>\n              <p class=\"rating\"> \n                \n                      Clasificaci\xF3n: A\n                 \n              </p>\n          </div>\n          <div>\n          <button title=\"Agregar a mi lista\" class=\"button-none add-favorites programing-button\" type=\"button\" _id=\"\">\n          <svg  xmlns=\"http://www.w3.org/2000/svg\" width=\"48\" height=\"44\" viewBox=\"0 0 48 44\">\n              <path class=\"heart-gray\" fill=\"none\" fill-rule=\" evenodd\" stroke=\"#7A7777\" stroke-width=\"3\" d=\"M33.709 2c-2.54 0-4.866.82-6.914 2.438-1.033.817-1.97 1.816-2.795 2.983-.825-1.166-1.762-2.166-2.795-2.983C19.157 2.821 16.83 2 14.29 2c-3.397 0-6.523 1.39-8.8 3.915C3.24 8.409 2 11.818 2 15.512c0 3.802 1.387 7.283 4.364 10.954 2.663 3.284 6.491 6.617 10.924 10.477 1.514 1.318 2.886 2.198 4.667 3.79C22.426 41.152 23.374 42 24 42c.626 0 1.574-.847 2.044-1.267 1.782-1.592 3.155-2.472 4.669-3.791 4.432-3.86 8.26-7.192 10.923-10.477C44.614 22.795 46 19.315 46 15.511c0-3.693-1.24-7.102-3.49-9.596C40.231 3.39 37.105 2 33.708 2z\"/>\n          </svg>\n          </button>\n          </div>\n      </div>\n      <div>\n      <span class=\"schedule-description s1\" id=\"synopsis-edi\">     ").concat(program.sinopsis, "    </span>\n    <span class=\"text-normal cursor-pointer a-text-bold-tealblue\"> Ver m\xE1s...</span>\n</div>\n  </div>\n</div>\n</div>\n</div> ");
  ...
  $.ajax({
    ...
    success: function success(result) {
      ...
      if (data.code == 200) {
        ...
        var programmingCanalClaro = data.data[0].programing[0].programs; //Programas de concert channel

        var programmingConcertChannel = data.data[1].programing[0].programs; //Programas de claro cinema

        var programmingClaroCinema = data.data[2].programing[0].programs;
        var programCanalClaroEdit = "";
        var programCanalClaro = "";
        var programConcertChannel = "";
        var programConcertChannelEdit = "";
        var programClaroCinema = "";
        var programClaroCinemaEdit = ""; //Iteramos el arreglo de programas de canal claro

        programmingCanalClaro.forEach(function (program) {
          programCanalClaro += "\n                    <div class=\"schedule-container\">\n                    <p class=\"schedule-title\">".concat(program.chapter_title, "</p>\n                    <div class=\"schedule-item-body\">\n                        <div class=\"schedule-poster\">\n                            <div class=\"poster\">\n                                <div class=\"thumbnail-prog\" _id=\"").concat(program.chapter_id, "\">\n                                    <img src=\"").concat(program.image, "\" alt=\"\">\n                                </div>\n                            </div>\n                        </div>\n        \n                        <div class=\"schedule-details\">\n                            <div class=\"schedule-details-header\">\n                                <div>\n                                    <p class=\"schedule\">").concat(program.time, " hrs.</p>\n                                    <p class=\"rating\">Clasificaci\xF3n: A</p>\n                                </div>\n                                <div>\n                                <button title=\"Eliminar de mi lista\" class=\"button-none add-favorites programing-button\" type=\"button\" _id=\"").concat(program.chapter_id, "\">\n                                <svg  xmlns=\"http://www.w3.org/2000/svg\" width=\"48\" height=\"44\" viewBox=\"0 0 48 44\">\n                                    <path class=\"heart-gray\" fill=\"none\" fill-rule=\" evenodd\" stroke=\"#7A7777\" stroke-width=\"3\" d=\"M33.709 2c-2.54 0-4.866.82-6.914 2.438-1.033.817-1.97 1.816-2.795 2.983-.825-1.166-1.762-2.166-2.795-2.983C19.157 2.821 16.83 2 14.29 2c-3.397 0-6.523 1.39-8.8 3.915C3.24 8.409 2 11.818 2 15.512c0 3.802 1.387 7.283 4.364 10.954 2.663 3.284 6.491 6.617 10.924 10.477 1.514 1.318 2.886 2.198 4.667 3.79C22.426 41.152 23.374 42 24 42c.626 0 1.574-.847 2.044-1.267 1.782-1.592 3.155-2.472 4.669-3.791 4.432-3.86 8.26-7.192 10.923-10.477C44.614 22.795 46 19.315 46 15.511c0-3.693-1.24-7.102-3.49-9.596C40.231 3.39 37.105 2 33.708 2z\"/>\n                                </svg>\n                                </button>\n                                </div>\n                            </div>\n                            <p class=\"schedule-description\">\n                                ").concat(program.sinopsis, "\n                            </p>\n                        </div>\n                    </div>\n    \n                </div>\n             \n                    "); //Truncar el texto

          var synopsis = program.sinopsis;
          /*                     if (program.sinopsis) {
          ...
          programCanalClaroEdit += "\n                    <div class=\"p-3 border-t border-r border-l border-b position-relative mb-3\">\n                    <img src=\"./images/General/pencil.svg\" alt=\"\" class=\"pencil edit-program-pencil\" chapter_id=\"".concat(program.chapter_id, "\">\n                    <div class=\"schedule-container col-12 p-5 mx-auto mt-0\">\n                        <p class=\"schedule-title  a-text-plus a-text-black-brown-two\">\n                            ").concat(program.chapter_title, "\n                        </p>\n                        <div class=\"schedule-item-body\">\n                            <div class=\"schedule-poster\">\n                                <div class=\"poster\">\n                                    <div class=\"thumbnail-edit\" _id=\"").concat(program.chapter_id, "\">\n                                        <img src=\"").concat(program.image, "\" alt=\"\" class=\"w-100\">\n                                    </div>\n                                </div>\n                            </div>\n                            <div class=\"schedule-details\">\n                                <div class=\"schedule-details-header\">\n                                    <div>\n                                        <p class=\"schedule a-text-black-brown-two\">\n                                            ").concat(program.time, " hrs.\n                                        </p>\n                                        <p class=\"rating\">\n                                            Clasificaci\xF3n: A\n                                        </p>\n                                    </div>\n                                    <div>\n                                        <button title=\"Agregar a mi lista\" class=\"button-none add-favorites programing-button\" type=\"button\" _id=\"\">\n                                            <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"48\" height=\"44\" viewBox=\"0 0 48 44\">\n                                                <path class=\"heart-gray\" fill=\"none\" fill-rule=\" evenodd\" stroke=\"#7A7777\" stroke-width=\"3\" d=\"M33.709 2c-2.54 0-4.866.82-6.914 2.438-1.033.817-1.97 1.816-2.795 2.983-.825-1.166-1.762-2.166-2.795-2.983C19.157 2.821 16.83 2 14.29 2c-3.397 0-6.523 1.39-8.8 3.915C3.24 8.409 2 11.818 2 15.512c0 3.802 1.387 7.283 4.364 10.954 2.663 3.284 6.491 6.617 10.924 10.477 1.514 1.318 2.886 2.198 4.667 3.79C22.426 41.152 23.374 42 24 42c.626 0 1.574-.847 2.044-1.267 1.782-1.592 3.155-2.472 4.669-3.791 4.432-3.86 8.26-7.192 10.923-10.477C44.614 22.795 46 19.315 46 15.511c0-3.693-1.24-7.102-3.49-9.596C40.231 3.39 37.105 2 33.708 2z\" />\n                                            </svg>\n                                        </button>\n                                    </div>\n                                </div>\n                                <div>\n                                    <span class=\"schedule-description s1\" id=\"synopsis-edi\">").concat(synopsis, "</span>\n                                    <span class=\"text-normal cursor-pointer a-text-bold-tealblue\"> Ver m\xE1s...</span>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                </div> \n                    ");
        });
        programmingConcertChannel.forEach(function (program) {
          programConcertChannel += "\n                    <div class=\"schedule-container\">\n                    <p class=\"schedule-title\">".concat(program.chapter_title, "</p>\n                    <div class=\"schedule-item-body\">\n                        <div class=\"schedule-poster\">\n                            <div class=\"poster\">\n                                <div class=\"thumbnail-prog\" _id=\"").concat(program.chapter_id, "\">\n                                    <img src=\"").concat(program.image, "\" alt=\"\">\n                                </div>\n                            </div>\n                        </div>\n        \n                        <div class=\"schedule-details\">\n                            <div class=\"schedule-details-header\">\n                                <div>\n                                    <p class=\"schedule\">").concat(program.time, " hrs.</p>\n                                    <p class=\"rating\">Clasificaci\xF3n: A</p>\n                                </div>\n                                <div>\n                                <button title=\"Eliminar de mi lista\" class=\"button-none add-favorites programing-button\" type=\"button\" _id=\"").concat(program.chapter_id, "\">\n                                <svg  xmlns=\"http://www.w3.org/2000/svg\" width=\"48\" height=\"44\" viewBox=\"0 0 48 44\">\n                                    <path class=\"heart-gray\" fill=\"none\" fill-rule=\" evenodd\" stroke=\"#7A7777\" stroke-width=\"3\" d=\"M33.709 2c-2.54 0-4.866.82-6.914 2.438-1.033.817-1.97 1.816-2.795 2.983-.825-1.166-1.762-2.166-2.795-2.983C19.157 2.821 16.83 2 14.29 2c-3.397 0-6.523 1.39-8.8 3.915C3.24 8.409 2 11.818 2 15.512c0 3.802 1.387 7.283 4.364 10.954 2.663 3.284 6.491 6.617 10.924 10.477 1.514 1.318 2.886 2.198 4.667 3.79C22.426 41.152 23.374 42 24 42c.626 0 1.574-.847 2.044-1.267 1.782-1.592 3.155-2.472 4.669-3.791 4.432-3.86 8.26-7.192 10.923-10.477C44.614 22.795 46 19.315 46 15.511c0-3.693-1.24-7.102-3.49-9.596C40.231 3.39 37.105 2 33.708 2z\"/>\n                                </svg>\n                                </button>\n                                </div>\n                            </div>\n                            <p class=\"schedule-description\">\n                                ").concat(program.sinopsis, "\n                            </p>\n                        </div>\n                    </div>\n    \n                </div>\n             \n                    "); //Truncar el texto
        ...
        programmingClaroCinema.forEach(function (program) {
          programClaroCinema += "\n                    <div class=\"schedule-container\">\n                    <p class=\"schedule-title\">".concat(program.chapter_title, "</p>\n                    <div class=\"schedule-item-body\">\n                        <div class=\"schedule-poster\">\n                            <div class=\"poster\">\n                                <div class=\"thumbnail-prog\" _id=\"").concat(program.chapter_id, "\">\n                                    <img src=\"").concat(program.image, "\" alt=\"\">\n                                </div>\n                            </div>\n                        </div>\n        \n                        <div class=\"schedule-details\">\n                            <div class=\"schedule-details-header\">\n                                <div>\n                                    <p class=\"schedule\">").concat(program.time, " hrs.</p>\n                                    <p class=\"rating\">Clasificaci\xF3n: A</p>\n                                </div>\n                                <div>\n                                <button title=\"Eliminar de mi lista\" class=\"button-none add-favorites programing-button\" type=\"button\" _id=\"").concat(program.chapter_id, "\">\n                                <svg  xmlns=\"http://www.w3.org/2000/svg\" width=\"48\" height=\"44\" viewBox=\"0 0 48 44\">\n                                    <path class=\"heart-gray\" fill=\"none\" fill-rule=\" evenodd\" stroke=\"#7A7777\" stroke-width=\"3\" d=\"M33.709 2c-2.54 0-4.866.82-6.914 2.438-1.033.817-1.97 1.816-2.795 2.983-.825-1.166-1.762-2.166-2.795-2.983C19.157 2.821 16.83 2 14.29 2c-3.397 0-6.523 1.39-8.8 3.915C3.24 8.409 2 11.818 2 15.512c0 3.802 1.387 7.283 4.364 10.954 2.663 3.284 6.491 6.617 10.924 10.477 1.514 1.318 2.886 2.198 4.667 3.79C22.426 41.152 23.374 42 24 42c.626 0 1.574-.847 2.044-1.267 1.782-1.592 3.155-2.472 4.669-3.791 4.432-3.86 8.26-7.192 10.923-10.477C44.614 22.795 46 19.315 46 15.511c0-3.693-1.24-7.102-3.49-9.596C40.231 3.39 37.105 2 33.708 2z\"/>\n                                </svg>\n                                </button>\n                                </div>\n                            </div>\n                            <p class=\"schedule-description\">\n                                ").concat(program.sinopsis, "\n                            </p>\n                        </div>\n                    </div>\n    \n                </div>\n             \n                    "); //Truncar el texto
        ...
        $('.claro-content-edit').html(programCanalClaroEdit); //Insertar programas en página

        $('.claro-content').html(programCanalClaro); //Insertar programas en página
...
var Slider = /*#__PURE__*/function () {
  ...
  _createClass(Slider, [{
    ...
    value: function createDaysSlider(landing) {
      /*Programación general*/
      var date = new Date();
      ...
      */
      ...
      var nextMonth = (0, _date.getMonth)(2);

      if (nextMonth < 10) {
        nextMonth = "0".concat((0, _date.getMonth)(2));
      }

      if (month < 10) {
        month = "0".concat((0, _date.getMonth)(1));
      }

      var day = date.getDate();

      if (day < 10) {
        day = "0".concat(getDate());
      }
      ...
      if (numberLastDays <= 15) {
        ...
        */
        ...
        for (var i = (0, _date.getDay)(); i <= (0, _date.getDays)(1); i++) {
          ...
          if (i == (0, _date.getDay)()) {
            if (i < 10) {
              daysSlider += "\n            <li rel=\"".concat(landing, "-").concat(i, "-").concat((0, _date.getMonth)(0), "\" class=\"").concat(landing, "-item programing-item ").concat(landing, "-active\" date=\"").concat(date.getFullYear(), "-").concat(month, "-0").concat(i, "\">\n              <div class=\"day\">\n                  <p class=\"day-text\">").concat((0, _date.getDayName)(currentMonth, i), "</p>\n                  <p class=\"day-number\">").concat(i, "</p>\n              </div>\n            </li>      \n        ");
            } else {
              daysSlider += "\n            <li rel=\"".concat(landing, "-").concat(i, "-").concat((0, _date.getMonth)(0), "\" class=\"").concat(landing, "-item programing-item ").concat(landing, "-active\" date=\"").concat(date.getFullYear(), "-").concat(month, "-").concat(i, "\">\n              <div class=\"day\">\n                  <p class=\"day-text\">").concat((0, _date.getDayName)(currentMonth, i), "</p>\n                  <p class=\"day-number\">").concat(i, "</p>\n              </div>\n            </li>      \n        ");
            }
          } else {
            if (i < 10) {
              //Días restantes
              daysSlider += "\n          <li rel=\"".concat(landing, "-").concat(i, "-").concat((0, _date.getMonth)(0), "\" class=\"").concat(landing, "-item programing-item\" date=\"").concat(date.getFullYear(), "-").concat(month, "-0").concat(i, "\">\n            <div class=\"day\">\n                <p class=\"day-text\">").concat((0, _date.getDayName)(currentMonth, i), "</p>\n                <p class=\"day-number\">").concat(i, "</p>\n            </div>\n          </li>      \n          ");
            } else {
              //Días restantes
              daysSlider += "\n          <li rel=\"".concat(landing, "-").concat(i, "-").concat((0, _date.getMonth)(0), "\" class=\"").concat(landing, "-item programing-item\" date=\"").concat(date.getFullYear(), "-").concat(month, "-").concat(i, "\">\n            <div class=\"day\">\n                <p class=\"day-text\">").concat((0, _date.getDayName)(currentMonth, i), "</p>\n                <p class=\"day-number\">").concat(i, "</p>\n            </div>\n          </li>      \n          ");
            }
          }
        ...
        for (var _i = 1; _i <= (0, _date.getDays)(2); _i++) {
          if (_i < 10) {
            daysSlider += "\n          <li rel=\"".concat(landing, "-").concat(_i, "-").concat((0, _date.getMonth)(1), "\" class=\"").concat(landing, "-item programing-item\" date=\"").concat(date.getFullYear(), "-").concat(nextMonth, "-0").concat(_i, "\">\n            <div class=\"day\">\n                <p class=\"day-text\">").concat((0, _date.getDayName)(currentMonth + 1, _i), "</p>\n                <p class=\"day-number\">").concat(_i, "</p>\n            </div>\n          </li>      \n      ");
          } else {
            daysSlider += "\n          <li rel=\"".concat(landing, "-").concat(_i, "-").concat((0, _date.getMonth)(1), "\" class=\"").concat(landing, "-item programing-item\" date=\"").concat(date.getFullYear(), "-").concat(nextMonth, "-").concat(_i, "\">\n            <div class=\"day\">\n                <p class=\"day-text\">").concat((0, _date.getDayName)(currentMonth + 1, _i), "</p>\n                <p class=\"day-number\">").concat(_i, "</p>\n            </div>\n          </li>      \n      ");
          }
        }
        ...
        for (var _i2 = (0, _date.getDay)(); _i2 <= totalDaysSlider; _i2++) {
          if (_i2 == (0, _date.getDay)()) {
            if (_i2 < 10) {
              //Día actual activo
              daysSlider += "\n            <li rel=\"".concat(landing, "-").concat(_i2, "-").concat((0, _date.getMonth)(0), "\" class=\"").concat(landing, "-item programing-item ").concat(landing, "-active\" date=\"").concat(date.getFullYear(), "-").concat(month, "-0").concat(_i2, "\">\n              <div class=\"day\">\n                  <p class=\"day-text\">").concat((0, _date.getDayName)(currentMonth, _i2), "</p>\n                  <p class=\"day-number\">").concat(_i2, "</p>\n              </div>\n            </li>      \n        ");
            } else {
              //Día actual activo
              daysSlider += "\n          <li rel=\"".concat(landing, "-").concat(_i2, "-").concat((0, _date.getMonth)(0), "\" class=\"").concat(landing, "-item programing-item ").concat(landing, "-active\" date=\"").concat(date.getFullYear(), "-").concat(month, "-").concat(_i2, "\">\n            <div class=\"day\">\n                <p class=\"day-text\">").concat((0, _date.getDayName)(currentMonth, _i2), "</p>\n                <p class=\"day-number\">").concat(_i2, "</p>\n            </div>\n          </li>      \n      ");
            }
          } else {
            if (_i2 < 10) {
              //Días siguientes
              daysSlider += "\n        <li rel=\"".concat(landing, "-").concat(_i2, "-").concat((0, _date.getMonth)(0), "\" class=\"").concat(landing, "-item programing-item\" date=\"").concat(date.getFullYear(), "-").concat(month, "-0").concat(_i2, "\">\n          <div class=\"day\">\n              <p class=\"day-text\">").concat((0, _date.getDayName)(currentMonth, _i2), "</p>\n              <p class=\"day-number\">").concat(_i2, "</p>\n          </div>\n        </li>      \n        ");
            } else {
              //Días siguientes
              daysSlider += "\n        <li rel=\"".concat(landing, "-").concat(_i2, "-").concat((0, _date.getMonth)(0), "\" class=\"").concat(landing, "-item programing-item\" date=\"").concat(date.getFullYear(), "-").concat(month, "-").concat(_i2, "\">\n          <div class=\"day\">\n              <p class=\"day-text\">").concat((0, _date.getDayName)(currentMonth, _i2), "</p>\n              <p class=\"day-number\">").concat(_i2, "</p>\n          </div>\n        </li>      \n        ");
            }
          }
        }
...
var Section = /*#__PURE__*/function () {
  ...
  _createClass(Section, [{
    ...
    value: function renderCanalClaro(json) {
      ...
      var data = json.data; //cambiamos el icono del landing
    ...
    value: function renderProgramation(json) {
      ...
      $('#icon_canal_claro').attr('src', "".concat(data.icon_canal_claro, "?v=").concat(new Date().getTime()));
      $('#icon_concert_channel').attr('src', "".concat(data.icon_concert_channel, "?v=").concat(new Date().getTime()));
      $('#icon_claro_cinema').attr('src', "".concat(data.icon_claro_cinema, "?v=").concat(new Date().getTime())); //agregamos el slider
    ...
    value: function renderProgramation_edi(json) {
      ...
      $('#icon_canal_claro_edi').attr('src', "".concat(data.icon_canal_claro, "?v=").concat(new Date().getTime()));
      $('#icon_concert_channel_edi').attr('src', "".concat(data.icon_concert_channel, "?v=").concat(new Date().getTime()));
      $('#icon_claro_cinema_edi').attr('src', "".concat(data.icon_claro_cinema, "?v=").concat(new Date().getTime())); //agregamos el slider
      ...
      $("#banner-programming-edi").not(".slick-initialized").slick({
        ...
        customPaging: function customPaging(slider, i) {
          ...
          return "<p class='a-text-bold-tealblue slider-pagination-item pag' slide_index=" + i + ">" + (i + 1) + "</p> ";
        }
      }); //para dar click
...
function recreateClickCalendar() {
  ...
  $("ul.claro-calendar .claro-item").click(function () {
    ...
    var country = (0, _country.getNameCountry)(localStorage.getItem("src")); //Petición ajax para traer la programación

    (0, _Program.getProgramming)(date);
    $("ul.claro-calendar .claro-item").removeClass("claro-active");
    $(this).addClass("claro-active");
    var activeNav = $(this).attr("rel");
    var stringLength = activeNav.length;
    var month = activeNav.charAt(stringLength - 1); //Mostrar contenido (Que es innecesario en estos momentos)
  ...
  $("ul.concert-calendar .concert-item").click(function () {
    ...
    var stringLength = activeNav.length;
    var month = activeNav.charAt(stringLength - 1);
    $(".month").text("".concat((0, _date.getMonthAndYear)(month))); //peticiones

    var date = $(this).attr("date");
    var country = (0, _country.getNameCountry)(localStorage.getItem("src"));
    (0, _Program.getProgramming)(date);
  });
