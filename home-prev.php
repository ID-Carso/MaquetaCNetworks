            ...
            <div class="header">
                ...
                <nav class="menu-tablet">
                    <div class="nav-content">
                        ...
                        <div class="login">
                            <a href="index.php" class="login-item"><img src="images/paises/gmt-icon.svg" alt="banderas-paises-por-region" width="32px"/></a>
                        </div>
                    </div>
                </nav>
                <?php
            ...
            <div class="claro-canal-mobile">
                <div class="m-home-titles text-center">
                    <a href="" class="home-title-link">
                        <img src="" class="claro-image-header" alt="logo-canal-claro"/>
                    </a>
