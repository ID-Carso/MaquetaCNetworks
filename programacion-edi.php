                            ...
                            <ul class="d-flex list-progra pl-0">
                                ...
                                <div class="text-center no-gap  mr-2">
                                    <li rel="claro-canal-programing-edit"
                                        class="navs-li active-navItems navbar-progra-item-container d-inline-block"
                                        ...
                                        <div class=" mx-auto position-relative thumbnail-image-program "
                                            ...
                                            <label for="imagelogo"
                                                ...
                                                <img class="claro-nav-image thumbnail-image-program" src="" alt="logo-claro-canal"
                                        ...
                                        <div class=" mx-auto position-relative thumbnail-image-program"
                                            ...
                                            <label for="imagelogo"
                                                ...
                                                <img class="cursor-auto claro-nav-image thumbnail-image-program" src=""
                                                    alt="logo-claro-cinema" id="icon_claro_cinema_edi" />
                                            </label>
                                        </div>
                                    </li>
                                </div>
