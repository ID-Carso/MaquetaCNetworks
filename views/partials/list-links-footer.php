    ...
    <div class="col-11 mx-auto list-links-footer">
        <div class="row no-gutters">
            <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
                <a href="about-us.php" class="link-landing-footer" id="f-link1">
                    <p class="text-landing-footer text-semibold" id="f-title1">¿Quiénes somos?</p>
                </a>
            </div>
            <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
                <a href="claro-canal.php" class="link-landing-footer" id="f-link2">
                    <p class="text-landing-footer text-semibold" id="f-title2">Canal Claro</p>
                </a>
            </div>
            <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
            ...
            <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
                <a href="https://nuestravision.tv" target="_blank" class="link-landing-footer" id="f-link6">
