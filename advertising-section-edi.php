        ...
        <div class="row">
            <div class="col-12 m-auto">
                <div class="adv-headline-mb">
                    <div class="p-3 bor position-relative">
                        <img src="./images/General/pencil.svg" alt="editar-contenido" class="pencil"/>
            ...
            <div class="col-12 no-gutters">
                <div class="p-3 bor position-relative d-inline-block">
                    <img src="./images/General/pencil.svg" alt="editar-contenido" class="pencil"/>
                    <img src="./images/General/image-synopsis-horizontal.png" class="w-100" alt="imagen-de-anuncio-para-mobile" />
                </div>
            </div>
        </div>
    </div>
    <!--End Sección de anuncion para mobile-->
    <!--Sección de anuncion para tablet-->
        ...
        <div class="col-lg-10 m-auto">
            <div class="row">
                <div class="col-6 m-auto">
                    <div class="p-3 bor position-relative d-inline-block">
                        <img src="./images/General/pencil.svg" alt="editar-contenido" class="pencil"/>
                        <img src="./images/General/image-synopsis-horizontal.png" class="w-100" alt="imagen-de-anuncio-para-tablet" />
        ...
        <div class="col-lg-12">
            <div class="row">
                <div class="col-5 col-lg-6">
                    <div class=" p-3 bor position-relative d-inline-block">
                        <img src="./images/General/pencil.svg" alt="editar-contenido" class="pencil"/>
                        <img src="./images/General/image-synopsis-horizontal.png" class="w-100 " alt="imagen-de-anuncio-para-desktop" />
