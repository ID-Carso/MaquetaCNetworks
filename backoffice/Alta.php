...
<html lang="en">
<div  id="general">
  <div class="col-xl-5 justify-content-center mx-auto title-altauser">
        ...
        <div class="col-xl-5  shadow mx-auto">  
           <div class="col-xl-12 mx-auto pt-2 ">
                  ...
                  <div class="pt-0 mt-1">
                    ...
                    <button type ="button" class=" btn-rol-all  btn-rol px-xl-0 enviamos ml-3 btn-rol-select " id="btn-rol" rel='User-Raiz' onClick="cambiaracti(1)">Usuario Raíz</button>
