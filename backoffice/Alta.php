...
<body>
<div  id="general"> <!--Div para cambio-->
  <div class="col-xl-6 mx-auto title-altauser tamaño-alta1" > <!--Inicio para tarjeta-->
     ...
     <div class="pr-4 pl-4 pt-2 pb-2"><strong > DATOS DEL USUARIO</strong></div>
        ...
        <div class="col-xl-6  shadow mx-auto tamaño-alta">  
           <div class="col-xl-12 mx-auto p-3 ">
                    <form>
                    <input class="insert-data Correo-electrnico pt-2 mb-2" type="text " value="" placeholder=" Nombre del usuario" ></input>
                  ...
                  <div class="pt-0 mt-0">
                    <input class="insert-data Correo-electrnico pt-2 mt-0 " type="password" id="login-password" name="login-password" placeholder=" Contraseña" autocomplete="off" />
                    ...
                    <img src="../images/registro/listo.svg" class="listo" />                                   
                     ...
                     <div class=" justify-content-center mx-auto "> <!--Sección de roles-->
                    <p class="p-4 mb-4 mt-4  border-rol Correo-electrnico ">Rol <!--recuadro rol-->
         ...
         <!--modal regis-->
<div class="modal show  " id="abrirListo" role="dialog"  >
