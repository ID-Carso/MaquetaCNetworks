             ...
             <div class="terms-conditions-desktop">
                 <div class="row aviso-border d-flex align-items-end">
                     <div class="col-12 col-md-10 col-lg-6 col-xl-6">
                         <div class="logo-footer">
                         <div class="col-3 p-3 border-t border-l border-r border-b position-relative">
                             <img src="../images/pencil.svg" alt="" class="pencil">
                             <img src="./images/home/claro-grey.svg" alt="" class="claro-grey-img" />
                            </div>
                         </div>
                         <div class="col-8 p-2 border-t border-l border-r border-b mb-2 position-relative">
                         <img src="../images/pencil.svg" alt="" class="pencil">
                         ...
                         <div class="d-flex">
                             <div>
                                 <a href="terminos.php">
                                 <div class="col-12 pt-4 mb-2 border-t border-l border-r border-b  position-relative">
                                      <img src="../images/pencil.svg" alt="" class="pencil">
                             ...
                             <div>
                                 <a href="aviso.php">
                                 <div class="col-12 pt-4 border-t border-l border-r border-b position-relative">
                                      <img src="../images/pencil.svg" alt="" class="pencil">
